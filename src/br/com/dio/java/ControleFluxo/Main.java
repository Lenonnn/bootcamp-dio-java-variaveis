package br.com.dio.java.ControleFluxo;
...
public class Main {
    ...
    // Embora funcione , evitar efeito flecha e excessos de IFs aninhados
                                            ...
                                            if (mes == 10) {
                                                ...
                                                if (mes == 11) {
                                                    ...
                                                    if (mes == 2) {
                                                        ...
                                                        System.out.println("Mês " + mes + " Indefinido !");
                                                    }
                                                }
                                            }
                                        }
    ...
    public static void ifSemFlecha(){
        ...
        if (mes == 1 ){
            ...
            System.out.println("Mês não localizado");
        }
